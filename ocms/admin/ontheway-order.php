...
<!DOCTYPE html>
<head>
<title>Online Catering Managements System | On the way Order</title>
...
<?php include_once('includes/sidebar.php');?>
	<section class="wrapper scrollable">
        ...
        $ret = "SELECT ID FROM tblorder where Status='On The Way'";
...
$sql="SELECT * from tblorder  where Status='On The Way' LIMIT $offset, $no_of_records_per_page";
